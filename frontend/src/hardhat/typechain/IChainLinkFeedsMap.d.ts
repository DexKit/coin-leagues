...
interface IChainLinkFeedsMapInterface extends ethers.utils.Interface {
  functions: {
...
export class IChainLinkFeedsMap extends Contract {
  ...
  interface: IChainLinkFeedsMapInterface;

...
interface CoinsLeagueSettingsMumbaiInterface extends ethers.utils.Interface {
  functions: {
...
export class CoinsLeagueSettingsMumbai extends Contract {
  ...
  interface: CoinsLeagueSettingsMumbaiInterface;

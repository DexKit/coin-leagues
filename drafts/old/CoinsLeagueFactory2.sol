 ...
 *
 */
contract CoinsLeagueFactory2 {
    CoinsLeague2[] public coinsLeague;
    ...
    ) external returns (CoinsLeague2 gameAddress) {
        gameAddress = new CoinsLeague2(
            _num_players,
            _duration,
            _amount,
            _num_coins,
